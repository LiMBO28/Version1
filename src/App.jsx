...
<button onClick={() => go('reviews')} className="font-serif text-3xl md:text-4xl text-[#fafaf8] hover:text-[#a8854c] transition-colors italic font-light">Leave a Review</button>
